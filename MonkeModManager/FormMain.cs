...
namespace MonkeModManager
{
    public partial class FormMain : Form
    {
        ...
        {
            var decodedMods = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/unblockedgames2/Monke-Mod-Manager/master/modinfo.json"));
            var decodedGroups = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/unblockedgames2/Monke-Mod-Manager/master/groupinfo.json"));
